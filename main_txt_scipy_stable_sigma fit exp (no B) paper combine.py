...
file_names = ['20240415', '20240416_01','20240417_01','20240417_02', '20240418_01','20240419_01','20240421_01','20240422_01','20240422_02','20240423_01','20240511','20240513', '20240521_01', '20240522']
# file_names =['20240417_02']
#-------ensure the save directorys are exist
analysis_result = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + ground_value 
...
for file_name in file_names:    
    ...
    count = 0
    file_path = "./new_lifetimedatatxt/Lifetime_data(no B)/" + file_name + ".txt"
    #-------------------------------------------------------#
