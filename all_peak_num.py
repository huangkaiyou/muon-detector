...
for time in range(500):
    ...
    # for i in [9]:
        ...
        total_value_sigma_ch2[loop].append(ch2_second_peak_height)
    ...
    for i in range(1) :
        ...
        for i in range(len(no_ch1_second_peak_index)):
            index = i
            if raw3[i + cut_index] > raw3[i + cut_index + 2] :
                new_index_ch1.append(index)
        for i in range(len(no_ch2_second_peak_index)):
            index = i
            if raw3[i + cut_index] > raw3[i + cut_index + 2] :
                new_index_ch2.append(index)
        ...
        ch1_second_peak_height = [ch1_second_peak_height[i] for i in ch1_second_peak_index]
        ch2_second_peak_height = [ch2_second_peak_height[i] for i in ch2_second_peak_index]
        ...
        no_total_index_sigma_ch1[loop].append(len(no_ch1_second_peak_index))
        no_total_index_sigma_ch2[loop].append(len(no_ch2_second_peak_index))
        
        no_total_value_sigma_ch1[loop].append(no_ch1_second_peak_height)
        no_total_value_sigma_ch2[loop].append(no_ch2_second_peak_height)
'''
'''
...
#%%
for i in range(1):
    no_combined_list = [item for sublist in no_total_value_sigma_ch2[i] for item in sublist]
    combined_list = [item for sublist in total_value_sigma_ch2[i] for item in sublist]
