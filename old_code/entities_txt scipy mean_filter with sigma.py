...
for file_name in folder_paths:
    count=0
    ch1_peak_index_file = open('./analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_index/ch1/' + f'{file_name}' + '.txt', 'r')
    ch2_peak_index_file = open('./analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_index/ch2/' + f'{file_name}' + '.txt', 'r')
    ch1_peak_value_file = open('./analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_value/ch1/' + f'{file_name}' + '.txt', 'r')
    ch2_peak_value_file = open('./analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_value/ch2/' + f'{file_name}' + '.txt', 'r')
    ...
    #     ch2_peak_value_file.close()
        ...
        savecsv_path = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/lifetimedata/'
