...
ch1_peak_index_file = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_index/ch1/'
ch1_peak_value_file = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_value/ch1/'

ch2_peak_index_file = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_index/ch2/'
ch2_peak_value_file = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/peak_value/ch2/'

peak_path_file = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + '/file_path/'
...
for file_name in file_names:
    #directory for frame
    frame_path = './analysis_result/lifetime/no B/scipy/' + f'threshold_second (mean, num_sigma({num_sigma}))' + mode + prominice_value + f'/frame/{file_name}/' 
