...
folder_paths = ['20240424', '20240428', '20240429', '20240429_02', '20240430', '20240501', '20240502', '20240504']
# folder_paths = [folder_paths_list[0]]
ch2_peak_value_lists = [] #store ch2 peak value
for file_name in folder_paths:
    count=0
    ch1_peak_index_file = open('./analysis_result/lifetime/with B/scipy/' + f'threshold_second ({threshold_second}v)' + mode + prominice_value + '/peak_index/ch1/' + f'{file_name}' + '.txt', 'r')
    ch2_peak_index_file = open('./analysis_result/lifetime/with B/scipy/' + f'threshold_second ({threshold_second}v)' + mode + prominice_value + '/peak_index/ch2/' + f'{file_name}' + '.txt', 'r')
    ch1_peak_value_file = open('./analysis_result/lifetime/with B/scipy/' + f'threshold_second ({threshold_second}v)' + mode + prominice_value + '/peak_value/ch1/' + f'{file_name}' + '.txt', 'r')
    ch2_peak_value_file = open('./analysis_result/lifetime/with B/scipy/' + f'threshold_second ({threshold_second}v)' + mode + prominice_value + '/peak_value/ch2/' + f'{file_name}' + '.txt', 'r')
    ...
    #     ch2_peak_value_file.close()
        ...
        savecsv_path = './analysis_result/lifetime/with B/scipy/' + f'threshold_second ({threshold_second}v)' + mode + prominice_value + '/lifetimedata/'
